...
public class SimplePathContainer extends PathContainer {
    ...
    @Override protected void performTraversal(
        ...
        if (fromView == null || direction == REPLACE) {
            ...
            Utils.waitForMeasure(
                    newView, new Utils.OnMeasuredCallback() {
                        @Override public void onMeasured(View view, int width, int height) {
                            runAnimation(
                                    containerView, finalFromView, view, direction,
    ...
    private void runAnimation(
            final ViewGroup container, final View from, final View to,
